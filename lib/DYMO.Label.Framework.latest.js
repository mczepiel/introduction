...
(function () {
    ...
    function ba (a, b) {
        for (var c = a.split("."), d = b || q, e; e = c.shift();) if (d[e]) d = d[e];
        else return m;
        return d
    }
    ...
    function Oa (a, b, c) {
        if (typeof a.forEach == "function") a.forEach(b, c);
            ...
            else if (typeof a.M != "function") if (v(a) || w(a)) {
                d = [];
    ...
    p.G = function () {
        ...
        for (var a = this.d.M(), b = this.d.G(), c = [], d = 0; d < b.length; d++) {
            var e = a[d];
            if (u(e)) for (var f = 0; f < e.length; f++) c.push(b[d]);
            else c.push(b[d])
        }
        return c
    };
    ...
    function Yb (a) {
        if (a && typeof a.length == "number") if (ea(a)) return typeof a.item == "function" || typeof a.item == "string";
    ...
    function kc (a, b, c) {
        ...
        if (q._callbacks_[a]) if (c) delete q._callbacks_[a];
        ...
        if (Dc) {
            ...
            try {
                if (h) {
                    ...
                    g = e[l];
                    g.s = g.c;
                    for (var B = r.length - 1; !k.S && B >= 0 && g.s; B--) {
                        k.currentTarget = r[B];
                        f &= bd(g, r[B], d, l, k)
                    }
                    if (j) {
    ...
    p.dispatchEvent = function (a) {
        ...
        if (d in e) {
            ...
            if (n in e) {
                ...
                } else for (c = this; !a.S && c && f.s; c = c.Ma) {
                    a.currentTarget = c;
            ...
            for (b = f.length; c < b; c++) {
                ...
                if (h != f[c].value) {
                    ...
                    if ("textContent" in g) g.textContent = h;
                        ...
                        Zb(g);
                        g.appendChild((g.nodeType == 9 ? g : g.ownerDocument || g.document).createTextNode(h))
                    }
                }
            }
    ...
    function Vd () {
        ...
        if (b.indexOf("Win") != -1) if (typeof ActiveXObject != "undefined") {
            ...
            a.la = l;
            if (Od("application/x-dymolabel")) a.$ = l;
    ...
    function qe (a, b, c, d) {
        function e (j, k) {
            ...
            (new gc(g, "c")).send({
                ...
                else k < 10 ? e(j, ++k) : M("dymo.label.framework").error('Unable to send print job data for "' + f + '": Max retry count reached')
            }, function () {
